...
def consulting(id):
    if request.method == 'GET':
        ...
        for student in my_students:
            consultings = Consulting.query.filter((Consulting.student_id==student['register_no']) & (Consulting.done != 1) | ( Consulting.done == None) & (Consulting.startdate <= current_time) & ( current_time <= Consulting.deadline )).all()
            print(consultings)
            target_data = {}
